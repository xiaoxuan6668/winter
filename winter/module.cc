...
static winter::ConfigVar<std::string>::ptr g_module_path
...
bool Module::onConnect(winter::Stream::ptr stream) {
    return true;
}

bool Module::onDisconnect(winter::Stream::ptr stream) {
    return true;
}
...
void ModuleManager::init() {
    ...
    winter::FSUtil::ListAllFile(files, path, ".so");
