...
int32_t FunctionWSServlet::onConnect(winter::http::HttpRequest::ptr header
...
int32_t FunctionWSServlet::onClose(winter::http::HttpRequest::ptr header
                                     ,winter::http::WSSession::ptr session) {
    if(m_onClose) {
...
int32_t FunctionWSServlet::handle(winter::http::HttpRequest::ptr header
