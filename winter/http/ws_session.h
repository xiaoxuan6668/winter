#ifndef __WINTER_HTTP_WS_SESSION_H__
#define __WINTER_HTTP_WS_SESSION_H__

#include "winter/config.h"
#include "winter/http/http_session.h"
#include <stdint.h>
...
extern winter::ConfigVar<uint32_t>::ptr g_websocket_message_max_size;
