...
int32_t FunctionServlet::handle(winter::http::HttpRequest::ptr request
...
int32_t ServletDispatch::handle(winter::http::HttpRequest::ptr request
               , winter::http::HttpResponse::ptr response
               , winter::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(winter::http::HttpRequest::ptr request
                   , winter::http::HttpResponse::ptr response
                   , winter::http::HttpSession::ptr session) {
    static const std::string& RSP_BODY = "<html><head><title>404 Not Found"
        "</title></head><body><center><h1>404 Not Found</h1></center>"
        "<hr><center>winter/1.0.0</center></body></html>";

    response->setStatus(winter::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "winter/1.0.0");
