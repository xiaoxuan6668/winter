...
public:
    ...
    virtual int32_t onConnect(winter::http::HttpRequest::ptr header
                              ,winter::http::WSSession::ptr session) = 0;
    virtual int32_t onClose(winter::http::HttpRequest::ptr header
                             ,winter::http::WSSession::ptr session) = 0;
    virtual int32_t handle(winter::http::HttpRequest::ptr header
...
public:
    ...
    typedef std::function<int32_t (winter::http::HttpRequest::ptr header
                              ,winter::http::WSSession::ptr session)> on_connect_cb;
    typedef std::function<int32_t (winter::http::HttpRequest::ptr header
                             ,winter::http::WSSession::ptr session)> on_close_cb; 
    typedef std::function<int32_t (winter::http::HttpRequest::ptr header
                           ,winter::http::WSFrameMessage::ptr msg
                           ,winter::http::WSSession::ptr session)> callback;
    ...
    virtual int32_t onConnect(winter::http::HttpRequest::ptr header
                              ,winter::http::WSSession::ptr session) override;
    virtual int32_t onClose(winter::http::HttpRequest::ptr header
                             ,winter::http::WSSession::ptr session) override;
    virtual int32_t handle(winter::http::HttpRequest::ptr header
                           ,winter::http::WSFrameMessage::ptr msg
