 ...
 * @brief Socket封装
 */
#ifndef __WINTER_SOCKET_H__
#define __WINTER_SOCKET_H__
...
public:
     ...
     * @param[in] address 地址
     */
    static Socket::ptr CreateTCP(winter::Address::ptr address);

    /**
     * @brief 创建UDP Socket(满足地址类型)
     * @param[in] address 地址
     */
    static Socket::ptr CreateUDP(winter::Address::ptr address);
...
public:
    ...
    static SSLSocket::ptr CreateTCP(winter::Address::ptr address);
