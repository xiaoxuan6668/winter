#ifndef __WINTER_MODULE_H__
#define __WINTER_MODULE_H__
...
public:
    ...
    virtual bool onConnect(winter::Stream::ptr stream);
    virtual bool onDisconnect(winter::Stream::ptr stream);
...
public:
    ...
    virtual bool handle(winter::RockRequest::ptr request
                        ,winter::RockResponse::ptr response
                        ,winter::RockStream::ptr stream) = 0;
    virtual bool handle(winter::RockNotify::ptr request
                        ,winter::RockStream::ptr stream) = 0;
};
...
typedef winter::Singleton<ModuleManager> ModuleMgr;
