...
void test_yaml() {
    YAML::Node root = YAML::LoadFile("/home/ubuntu/MyProjects/cpp/Winter/bin/conf/test.yml");
    print_yaml(root, 0);
...
void test_class(){
    ...
    YAML::Node root = YAML::LoadFile("/home/ubuntu/Projects/Winter/bin/conf/log.yml");
    winter::Config::LoadFromYaml(root);
